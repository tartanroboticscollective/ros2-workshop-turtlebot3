#!/usr/bin/env bash
# ----------------------------------------------------------------
# Run Simulation - 3D Mapping session
# ----------------------------------------------------------------
...
usage() {
    echo "
Usage: start_3dmapping.sh [-m|--model] turtlebot3_model [-h|--help]
